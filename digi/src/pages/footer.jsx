      ...
      <div className="footer-content">
        ...
        <div className="footer-col col-company">
          ...
          <div className="social-icons">
            {/* WhatsApp */}
            <a href="https://wa.me/6285924101807?text=Halo,%20saya%20ingin%20betanya?" className="icon-box">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/digiteknoindo/" className="icon-box">
            ...
            {/* Mail */}
            <a href="mailto:digiteknoindo@gmail.com" className="icon-box">
          ...
          <p className="copyright">Copyright © 2025 Digi tekno indonesai</p>
        </div>
